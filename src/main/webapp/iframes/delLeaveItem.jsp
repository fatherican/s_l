...
<head>
  ...
  <script type="text/javascript">
		$(document).ready(function(){
            ...
            window.parent.changeAddress("leave/delLeaveItem")
            $("#submitBT").bind("click",function(){
                ...
                $.ajax({
                    type: "POST",
                    dataType: "html",
                    url:host+"/leave/delLeaveItem.do",
		...
		<form class="form-inline" name="subForm" method="post" id="subForm">
			...
			<p>
                ...
                <span class="add-on">leaveId</span>
                    <input class="span2" type="text" name="leaveId" value='1' />
            </p>
